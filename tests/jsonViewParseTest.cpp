...
using DFTF = moped::DefaultTimePointFormatter<std::chrono::milliseconds>;

using namespace moped::tests;
using namespace moped::tests::view;
...
TEST_CASE("Instrument Data load Test with full payload parser and full "
  ...
  auto result = moped::parseCompositeFromJSONView<ExchangeInfo>(
      DFTF{}, instrumentData_view);
